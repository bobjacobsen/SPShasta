...
signal = SignalHeadSection(rightward, leftward, "CTC 14 L", "CTC 14 C", "CTC 14 R", "CTC 14 L", "CTC 14 R", station);
station.add(signal)

rightward = arrayList(["16 R Siding"])
leftward  = arrayList(["16 L Siding"])
signal = SignalHeadSection(rightward, leftward, "CTC 16 L", "CTC 16 C", "CTC 16 R", "CTC 16 L", "CTC 16 R", station);
station.add(signal)
...
leftward  = arrayList([])
signal = SignalHeadSection(rightward, leftward, "CTC 18 L", "CTC 18 C", "CTC 18 R", "CTC 18 L", "CTC 18 R", station);
station.add(signal)

rightward = arrayList(["20 R Upper", "20 R Lower"])
leftward  = arrayList([])
signal = SignalHeadSection(rightward, leftward, "CTC 20 L", "CTC 20 C", "CTC 20 R", "CTC 20 L", "CTC 20 R", station);
station.add(signal)
...
signal = SignalHeadSection(rightward, leftward, "CTC 32 L", "CTC 32 C", "CTC 32 R", "CTC 32 L", "CTC 32 R", station);
station.add(signal)

rightward = arrayList(["34 R Siding"])
leftward  = arrayList(["34 L Lower", "34 L Upper"])
signal = SignalHeadSection(rightward, leftward, "CTC 34 L", "CTC 34 C", "CTC 34 R", "CTC 34 L", "CTC 34 R", station);
station.add(signal)

station.add(MaintainerCallSection("CTC 32 Call","MC 32", station))

# ===== Set up Station 35/26/38 =====
...
signal = SignalHeadSection(rightward, leftward, "CTC 36 L", "CTC 36 C", "CTC 36 R", "CTC 36 L", "CTC 36 R", station);
station.add(signal)

rightward = arrayList(["38 R Siding"])
leftward  = arrayList(["38 L Lower", "38 L Upper"])
signal = SignalHeadSection(rightward, leftward, "CTC 38 L", "CTC 38 C", "CTC 38 R", "CTC 38 L", "CTC 38 R", station);
station.add(signal)
...
turnout = TurnoutSection("TO 39", "CTC 39 N", "CTC 39 R", "CTC 39 N", "CTC 39 R", station)
station.add(turnout)
...
turnout = TurnoutSection("TO 41", "CTC 41 N", "CTC 41 R", "CTC 41 N", "CTC 41 R", station)
station.add(turnout)
...
turnout.addLocks(java.util.Arrays.asList([occupancyLock, routeLock, routeLock2]));
